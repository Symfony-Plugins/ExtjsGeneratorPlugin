...
/**
 * @class Ext.ux.ListViewPanel
 * @extends Ext.Panel A base class that contains the reusable bits of
 *          configuration for ListViews in a Panel. It uses the
 *          {@link Ext.layout.FitLayout fit} layout to stretch the
 *          {@link Ext.chart.Chart} instance. <br />
 * @constructor
 * @param {Object}
 *          config The config object
 */

Ext.ux.ListViewPanel = Ext.extend(Ext.Panel, {
  layout : 'fit',
  initComponent : function() {
    this.items = this.buildListView();

    Ext.ux.ListViewPanel.superclass.initComponent.call(this);

...
/**
 * @class Ext.ux.grid.plugin.RowExpander
 ...
 * @ptype rowexpander
 */
Ext.ux.grid.plugin.RowExpander = Ext.extend(Ext.util.Observable, {
  /**
   * @cfg {Boolean} expandOnEnter <tt>true</tt> to toggle selected row(s)
   *      between expanded/collapsed when the enter key is pressed (defaults to
   *      <tt>true</tt>).
   */
  expandOnEnter : true,
  /**
  ...
  constructor : function(config) {
    ...
    this.addEvents({
      /**
       * @event beforeexpand Fires before the row expands. Have the listener
       *        return false to prevent the row from expanding.
       * @param {Object}
      ...
      expand : true,
      /**
       * @event beforecollapse Fires before the row collapses. Have the listener
       *        return false to prevent the row from collapsing.
       * @param {Object}
       *          this RowExpander object.
       * @param {Object}
       *          Ext.data.Record Record for the selected row.
    ...
    Ext.ux.grid.plugin.RowExpander.superclass.constructor.call(this);
  ...
  onDestroy : function() {
     ...
     * which means the mainBody won't be available. On the off chance that the
     * plugin isn't destroyed with the grid, take care of removing the listener.
     */
...
Ext.preg('rowexpander', Ext.ux.grid.plugin.RowExpander);

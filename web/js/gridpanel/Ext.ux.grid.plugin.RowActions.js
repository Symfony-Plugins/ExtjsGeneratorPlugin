...
Ext.extend(Ext.ux.grid.plugin.RowActions, Ext.util.Observable, {
  ...
  // {{{
  /**
   * @cfg {Array} actions Mandatory. Array of action configuration objects. The
   *      action configuration object recognizes the following options:
   *      <ul class="list">
   ...
   *      <li style="list-style-position:outside"> {String} <b>iconCls</b> CSS
   *      class of the icon to show. It is ignored if iconIndex is configured.
   *      Use this if you want static icons that are not base on the values in
   *      the record. </li>
   *      <li style="list-style-position:outside"> {Boolean} <b>hide</b>
   *      Optional. True to hide this action while still have a space in the
   *      grid column allocated to it. IMO, it doesn't make too much sense, use
   *      hideIndex instead. </li>
   ...
   *      Optional. Field name of the field of the grid store record that
   *      contains tooltip text. If configured, the tooltip texts are taken from
   *      the store. </li>
   *      <li style="list-style-position:outside"> {String} <b>tooltip</b>
   *      Optional. Tooltip text to use as icon tooltip. It is ignored if
   *      qtipIndex is configured. Use this if you want static tooltips that are
   *      not taken from the store. </li>
   *      <li style="list-style-position:outside"> {String} <b>qtip</b> Synonym
   *      for tooltip </li>
   *      <li style="list-style-position:outside"> {String} <b>textIndex</b>
   *      Optional. Field name of the field of the grids store record that
   *      contains text to display on the right side of the icon. If configured,
   *      the text shown is taken from record. </li>
  ...
  /**
   * @cfg {Boolean} editable - Do not touch! Must be false to prevent errors in
   *      editable grids
   */
  ,
  editable : false
   ...
   *      grouping grids. These actions support static icons, texts and tooltips
   *      same way as {@link #actions}. There is one more action config option
   *      recognized:
   *      <ul class="list">
   *      <li style="list-style-position:outside"> {String} <b>align</b> Set it
   *      to 'left' to place action icon next to the group header text.
  ...
  /**
   * @cfg {Boolean} isColumn Tell ColumnModel that we are column. Do not touch!
   * @private
   */
  ,
  isColumn : true
   ...
   *      'visibility' and 'display' (defaluts to 'visibility'). If the mode is
   *      visibility the hidden icon is not visible but there is still blank
   *      space occupied by the icon. In display mode, the visible icons are
   *      shifted taking the space of the hidden icon.
   */
  ,
  hideMode : 'visibility'
  ...
  /**
   * @cfg {Number} widthSlope Constant used for auto-width calculation (defaults
   *      to 21). See {@link #autoWidth} for explanation.
   */
  ,
  widthSlope : 21
  // }}}

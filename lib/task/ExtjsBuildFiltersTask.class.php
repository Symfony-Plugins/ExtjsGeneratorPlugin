...
The [extjs:build-filters|INFO] task creates filter form classes from the schema:

  [./symfony extjs:build-filters|INFO]
...
You can use another connection by using the [--connection|COMMENT] option:
  ...
  [./symfony extjs:build-filters --connection="name"|INFO]
...
EOF;
  ...
  {
    $this->logSection('extjs', 'generating filter form classes');

 ...
 */
class ExtjsPropelBuildFormsTask extends sfPropelBaseTask
{
  ...
  protected function configure()
  {
    $this->addOptions(array(
      ...
      new sfCommandOption('generator-class', null, sfCommandOption::PARAMETER_REQUIRED, 'The generator class', 'ExtjsFormGenerator')
    ));
...
The [extjs:build-forms|INFO] task creates form classes from the schema:

  [./symfony extjs:build-forms|INFO]
...
You can use another connection by using the [--connection|COMMENT] option:
  ...
  [./symfony extjs:build-forms --connection="name"|INFO]
...
EOF;
  ...
  {
    $this->logSection('extjs', 'generating form classes');

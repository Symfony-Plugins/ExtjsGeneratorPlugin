...
<?php include dirname(__FILE__).'/../../parts/objectActionsAction.php' ?>

<?php include dirname(__FILE__).'/../../parts/bottomToolbarAction.php' ?>

<?php include dirname(__FILE__).'/../../parts/topToolbarAction.php' ?>

<?php include dirname(__FILE__).'/../../parts/datastoreAction.php' ?>

<?php include dirname(__FILE__).'/../../parts/columnRenderersAction.php' ?>

<?php include dirname(__FILE__).'/../../parts/columnModelAction.php' ?>
...
<?php include dirname(__FILE__).'/../../parts/filterpanelAction.php' ?>

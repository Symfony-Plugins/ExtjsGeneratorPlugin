...
$configArr = Array(
  ...
  'source' => "
    ...
    if(!<?php echo sfConfig::get('app_extjs_gen_plugin_module_tab_panel_name') ?>.findById(id+this.title)){
      ...
      <?php echo sfConfig::get('app_extjs_gen_plugin_module_tab_panel_name') ?>.setActiveTab(<?php echo sfConfig::get('app_extjs_gen_plugin_module_tab_panel_name') ?>.findById(id+this.title));
    }
  "
);

  <?php echo sfConfig::get('app_extjs_gen_plugin_module_listpanel_name', 'Ext.app.sf.ListPanel') ?> = new Ext.app.sf.<?php echo ucfirst($this->getModuleName()) . str_replace('panel', 'Panel', ucfirst($this->configuration->getListLayout())) ?>({
...
<?php else: ?>
  ...
  <?php echo sfConfig::get('app_extjs_gen_plugin_module_tabpanel_name', 'Ext.app.sf.TabPanel') ?> = new Ext.app.sf.<?php echo ucfirst($this->getModuleName()) ?>TabPanel({
...
<?php if($this->configuration->hasFilterForm() && !$this->configuration->filterpanelIsDisabled()):?>
  <?php echo sfConfig::get('app_extjs_gen_plugin_module_filterpanel_name', 'Ext.app.sf.FilterPanel') ?> = new Ext.app.sf.<?php echo ucfirst($this->getModuleName()) ?>FilterPanel();

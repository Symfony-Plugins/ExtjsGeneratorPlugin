...
<?php unset($this->config['datastore']['partials']) ?>
  ...
  public function getDatastoreExtends()
  {
    return <?php echo isset($this->config['datastore']['extends']) ? "'{$this->config['datastore']['extends']}'" : 'null' ?>;
<?php unset($this->config['datastore']['extends']) ?>
  }

...
<?php unset($this->config['actions']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['form']['actions']) ? $this->config['form']['actions'] : array('_reload' => null, '_save' => null, '_savenew' => null, '_delete' => null, '_cancel' => null)) ?>;
